...
define([
    ...
    var FormDateRangePickerView = ContrailView.extend({
        render: function () {
            var self = this,
                dateRangePickerTemplate = contrail.getTemplate4Id(cowc.TMPL_DATERANGEPICKER_VIEW),
            ...
            self.$el.html(dateRangePickerTemplate(tmplParameters));
    ...
    return FormDateRangePickerView;
});